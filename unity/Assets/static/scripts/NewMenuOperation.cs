...
public class NewMenuOperation : MonoBehaviour
{
    ...
    public static void ExportPLY()
    {
        ...
        foreach (Transform child in parent.transform)
        {
            ...
            TextWriter writer = File.CreateText(Application.dataPath + "/Data/Exported/" + lod.name+ ".ply");
    ...
    {
        string folderPath = Application.dataPath + "/Data/Saves/SaveN" + GameData.singleton.numberofsaves + "/";
        string folderPathPly = Application.dataPath + "/Data/Saves/SaveN" + GameData.singleton.numberofsaves + "/Ply/";
    ...
    {
        if (GameData.singleton.NewSession)
        {
            Directory.CreateDirectory(Application.dataPath + "/Data/Saves/SaveN" + (++GameData.singleton.numberofsaves));
            Directory.CreateDirectory(Application.dataPath + "/Data/Saves/SaveN" + GameData.singleton.numberofsaves + "/Ply");
        }
        ...
        for (int i = 0; i < meshName.Count; i++)
        {
            ...
            if (meshName[i] != "batman")
            {
                ...
                ColorExporter exporter = new ColorExporter(Application.dataPath + "/Data/Saves/SaveN" + GameData.singleton.numberofsaves + "/" + MeshController.singleton.meshName[i] + ".txt", collider.sharedMesh.vertices, colorVector);
                exporter.MeshToFile();
                TextWriter writer = File.CreateText(Application.dataPath + "/Data/Saves/SaveN" + GameData.singleton.numberofsaves + "/Ply/" + MeshController.singleton.meshName[i] + ".ply");
